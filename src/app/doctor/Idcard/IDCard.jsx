...
export default function IdCard({ doctor }) {
  // If no doctor is passed, show a fallback
  if (!doctor) {
    return (
      <div className="p-6">
  ...
  // State for front/back card
  const [activeSide, setActiveSide] = useState("front");

  // State for QR code data
  const [qrCode, setQrCode] = useState("");

  // Generate QR code from the doctor’s data
  useEffect(() => {
  ...
  // Download card as PNG using dom-to-image
  const downloadCard = async () => {
    try {
      const element = document.getElementById("card");
      if (element) {
        // Pass crossOrigin and cacheBust options
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      <div className="max-w-md mx-auto space-y-6">
        ...
        >
          {/* Slide container for front/back sides */}
          <div
          ...
          >
            ...
            <div className="absolute inset-0 bg-slate-50">
              ...
              <div className="relative z-10 h-full flex flex-col p-5">
                {/* Logo in corner (use <img> with crossOrigin) */}
                ...
                <div className="relative mb-36 text-center">
                  ...
                  <div className="text-xs text-gray-500 space-y-0.5">
                    <p>
                      Membership No: {doctor.membershipNumber || "0001"}
                    </p>
            ...
            <div className="absolute inset-0 translate-x-full justify-items-center mt-32">
              <div className="relative z-10 h-full p-6">
                ...
                <div className="space-y-1 text-sm text-gray-600">
                  <p>
                    Institute:{" "}
                    {doctor.applicantAffiliation?.institution || "N/A"}
                  </p>
        ...
        {/* Controls for Flip and Download */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
          <button
            onClick={() =>
              setActiveSide((side) => (side === "front" ? "back" : "front"))
            }
            className="flex-1 bg-cyan-600 hover:bg-cyan-700 rounded-3xl h-12 text-white"
          >
            Flip Card
          </button>
