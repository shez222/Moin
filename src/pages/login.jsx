      ...
      <div className="w-full lg:w-2/5 my-8 mx-auto bg-white rounded-lg shadow-xl px-8 lg:px-32 py-12 lg:py-52 mr-0 lg:mr-5">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full border rounded-md py-2 pl-10 pr-10 focus:outline-none focus:ring-2 focus:ring-teal-400"
            />
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            >
              {showPassword ? (
                // Eye Closed Icon (You can replace this SVG with any icon you prefer)
                <svg
        ...
        {/* Login Button */}
        <button className="w-full bg-teal-500 text-white py-2 rounded-md font-medium hover:bg-teal-600 transition duration-200">
          Login
        </button>
